...
const MobileNav = ({ isOpen, toggleMenu }) => {
  return (
    <div
      className={`fixed top-0 right-0 h-screen w-full overflow-hidden bg-[rgba(0,0,0,0.3)] z-[999] shadow-[0px_29px_80px_rgba(0,0,0,0.3)] transition-transform duration-300 transform ${
